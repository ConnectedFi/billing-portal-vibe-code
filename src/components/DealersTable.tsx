							...
							filteredDealers.map((dealer) => (
								<TableRow key={dealer.dealerName}>
									...
									<TableCell className="text-right">
										{dealer.transactionCount}
									</TableCell>
									<TableCell className="text-right">
										{formatCurrency(dealer.totalAmountDrawn)}
									</TableCell>
									<TableCell className="text-right">
										{formatCurrency(dealer.totalInterestAccrued)}
									</TableCell>
									<TableCell className="text-right">
										{formatCurrency(dealer.totalCfiMargin)}
									</TableCell>
									<TableCell className="text-right">
										{formatCurrency(dealer.receivableFromCFA)}
									</TableCell>
									<TableCell className="text-right">
										{formatCurrency(dealer.payableToCFA)}
									</TableCell>
								</TableRow>
							))
						)}
