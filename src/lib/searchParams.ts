...
export const searchParamsSchema = z.object({
	...
	typeFilter: z
		.union([transactionTypeSchema, z.literal("all")])
		.optional()
		.default("all"),
...
export const encodeAggregates = (
	aggregates: Record<string, AggregateType>,
): string => {
...
export const decodeAggregates = (
	aggregatesString: string,
